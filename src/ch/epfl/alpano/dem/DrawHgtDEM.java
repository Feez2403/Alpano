...
final class DrawHgtDEM {
    ...
    final static double ORIGIN_LON = toRadians(7.21);
    final static double ORIGIN_LAT = toRadians(46.03);
    final static double WIDTH = toRadians(0.75);
    final static int IMAGE_SIZE = 300;
    final static double MIN_ELEVATION = 200;
    final static double MAX_ELEVATION = 4_500;
